 ...
 */
export declare const renderDataGridBody_unstable: (state: DataGridBodyState) => JSXElement;

/**
 * Render the final JSX of DataGridCell
 */
export declare const renderDataGridCell_unstable: (state: DataGridCellState) => JSXElement;

/**
 * Render the final JSX of DataGridHeader
 */
export declare const renderDataGridHeader_unstable: (state: DataGridHeaderState) => JSXElement;

/**
 * Render the final JSX of DataGridHeaderCell
 */
export declare const renderDataGridHeaderCell_unstable: (state: DataGridHeaderCellState) => JSXElement;

/**
 * Render the final JSX of DataGridRow
 */
export declare const renderDataGridRow_unstable: (state: DataGridRowState) => JSXElement;

/**
 * Render the final JSX of DataGridSelectionCell
 */
export declare const renderDataGridSelectionCell_unstable: (state: DataGridSelectionCellState) => JSXElement;

/**
 * Render the final JSX of Table
 */
export declare const renderTable_unstable: (state: TableState, contextValues: TableContextValues) => JSXElement;

/**
 * Render the final JSX of TableBody
 */
export declare const renderTableBody_unstable: (state: TableBodyState) => JSXElement;

/**
 * Render the final JSX of TableCell
 */
export declare const renderTableCell_unstable: (state: TableCellState) => JSXElement;

/**
 * Render the final JSX of TableCellActions
 */
export declare const renderTableCellActions_unstable: (state: TableCellActionsState) => JSXElement;

/**
 * Render the final JSX of TableCellLayout
 */
export declare const renderTableCellLayout_unstable: (state: TableCellLayoutState, contextValues: TableCellLayoutContextValues) => JSXElement;

/**
 * Render the final JSX of TableHeader
 */
export declare const renderTableHeader_unstable: (state: TableHeaderState) => JSXElement;

/**
 * Render the final JSX of TableHeaderCell
 */
export declare const renderTableHeaderCell_unstable: (state: TableHeaderCellState) => JSXElement;

/**
 * Render the final JSX of TableResizeHandle
 */
export declare const renderTableResizeHandle_unstable: (state: TableResizeHandleState) => JSXElement;

/**
 * Render the final JSX of TableRow
 */
export declare const renderTableRow_unstable: (state: TableRowState) => JSXElement;

/**
 * Render the final JSX of TableSelectionCell
 */
export declare const renderTableSelectionCell_unstable: (state: TableSelectionCellState) => JSXElement;
